...
# create droplet
curl -s -X POST -H 'Content-Type: application/json' -H 'Authorization: Bearer '$API_KEY'' -d '{  "name": "'$DROPLET_NAME'",  "region": "ams3",  "size": "8gb",  "image": "'$SNAPSHOT_ID'",  "ssh_keys": null,  "backups": false,  "ipv6": true,  "user_data": null,  "private_networking": null}' "https://api.digitalocean.com/v2/droplets" | jq '.'
